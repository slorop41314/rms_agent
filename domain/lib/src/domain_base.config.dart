...
import 'package:domain/src/use_case/auth/listen_auth_event_change_use_case.dart'
    as _i7;
import 'package:domain/src/use_case/auth/login_with_email_use_case.dart' as _i8;
import 'package:domain/src/use_case/auth/logout_use_case.dart' as _i9;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.GetResellerProfileByReferralCodeUseCase>(() =>
        _i6.GetResellerProfileByReferralCodeUseCase(
            gh<_i4.ResellerRepository>()));
    gh.factory<_i7.ListenAuthEventChangeUseCase>(
        () => _i7.ListenAuthEventChangeUseCase(gh<_i4.AuthRepository>()));
    gh.factory<_i8.LoginWithEmailUseCase>(
        () => _i8.LoginWithEmailUseCase(gh<_i4.AuthRepository>()));
    gh.factory<_i9.LogoutUseCase>(
        () => _i9.LogoutUseCase(gh<_i4.AuthRepository>()));
    gh.factory<_i10.RegisterWithEmailUseCase>(
        () => _i10.RegisterWithEmailUseCase(
              gh<_i4.AuthRepository>(),
              gh<_i4.ResellerRepository>(),
            ));
    return this;
